...
$lastFiveBlogsQuery = $connection->query("SELECT * FROM blogs ORDER BY created_at DESC LIMIT 5");
$lastFiveBlogs = $lastFiveBlogsQuery->fetchAll(PDO::FETCH_ASSOC);

$topFiveBlogsQuery = $connection->query("SELECT * FROM blogs ORDER BY view_count DESC LIMIT 5");
                            ...
                            <div class="card">
                                ...
                                <div class="card-body">
                                    ...
                                    <?php if ($blog['user_id'] == $_SESSION['user_id']): ?>
                                        ...
                                        <a href="blog/deleteblog.php?id=<?php echo $blog['id']; ?>" class="btn btn-danger" onclick="return confirm('Are you sure you want to delete this blog?');">Delete</a>
                                    <?php endif; ?>
                                </div>
                            </div>
                        </div>
